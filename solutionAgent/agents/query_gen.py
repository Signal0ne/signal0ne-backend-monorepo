...
class ChatAgent:
    ...
    def gen_ques(self, logs):
        ...
        prompt = f"""You are a helpful assistant that helps generate 3 highly descriptive relevant queries from a set of error logs.
        You can also include parts from the logs in your questions. You return a json with the queries. Do not forget to add relevant
        summarized context from logs with specific log statements to each of your queries.
        Here are the logs: {logs}\n
        Output format is {{question:,context:}}. Json:"""
